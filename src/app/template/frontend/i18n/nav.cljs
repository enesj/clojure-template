(ns app.template.frontend.i18n.nav)
...
(def dicts
  {:bs
   {;; Confirm dialog defaults
    ...
    :nav/expense-contexts    "Konteksti troškova"
   ...
   {;; Confirm dialog defaults
    ...
    :nav/upload              "Upload"
    :nav/add-utility         "Add utility bill"
    :nav/reports             "Reports"
    ...
    :nav/expense-contexts    "Expense Contexts"
